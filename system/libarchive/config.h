...
/* If we lack int64_t, define it to the first of __int64, int, long, and
 * long long that exists and is the right size.
 */
...
/* Define to 1 if you have the declaration of `ACE_GETACLCNT', and to 0 if
 * you don't.
 */
...
/* Define to 1 if you have the declaration of `ACL_TYPE_EXTENDED', and to 0
 * if you don't.
 */

/* #undef HAVE_DECL_ACL_TYPE_EXTENDED */

/* Define to 1 if you have the declaration of `ACL_TYPE_NFS4', and to 0 if
 * you don't.
 */
...
/* Define to 1 if you have the declaration of `SETACL', and to 0 if you
 * don't.
 */
...
/* Define to 1 if you have the declaration of `GETACL', and to 0 if you
 * don't.
 */
